...
namespace Task
{
    public partial class UserLogin : Form
    {
        ...
        private void btnSignUp_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(this.txtEmailLog.Text) | string.IsNullOrEmpty(this.txtPassword.Text))
            {
        ...
        private void txtEmailLog_TextChanged(object sender, EventArgs e)
        {
